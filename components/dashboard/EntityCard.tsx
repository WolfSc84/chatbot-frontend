...
export function EntityCard({ item }: { item: EntityItem }) {
  return (
    <div className="group flex items-start gap-3 rounded-lg border border-gray-200 bg-white p-3 transition-colors hover:border-accent-400 hover:bg-accent-50/40 dark:border-navy-700 dark:bg-navy-800 dark:hover:bg-navy-700">
